...
{% block content %}
  <div class="header container">
    <div class="row">
      <div class="col-md-12">
        <div class="title">
          <h1>12th edition - 25th November 2017</h1>
          <h2>
            in Munich,
  ...
  <div class="intro container content">
    ...
    <div class="row">
      <div class="col-md-offset-2 col-md-8">
        ...
        <ul>
          <li><img src="./flag/blank.gif" class="flag flag-de" /> Munich</li>
          <li>Participants: 35</li>
          <li>Location: <a href="http://www.westwing.de/">Westwing</a></li>
          <li><a href="http://www.meetup.com/JavaScript-CodeRetreat/events/218817407/">Meetup page</a></li>
        </ul>
        <p>
        </p>
      </div>
