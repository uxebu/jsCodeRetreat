        ...
        <div class="col-md-12">
          <div class="title">
            ...
            <a href="events.html" class="btn yellow">
              10th edition, to be announced, global
            </a>
  ...
  <div class="sponsors">
    <div class="container">
      <div class="col-md-12" style="text-align: center;">
        <a href="http://twitter.com/jsCodeRetreat">Want to sponsor? Ping us.</a>
    ...
    <div class="container">
      <div class="col-md-offset-2 col-md-4">
        ...
        <p>
          ...
          <br/>
          There is none near you? Make the <a href="events.html">next one</a> happen in your city.
        </p>
      </div>
    ...
    <div class="container">
      ...
      <div class="col-md-4">
        ...
        <p>
          ...
          Find all info on <a href="events.html">this site</a>.
        </p>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <div class="row buttons">
        <!--<div class="col-md-3 col-md-offset-3">-->
          <a href="events.html" class="btn yellow">Upcoming JSCR</a>
        <!--</div>-->
        <!--<div class="col-md-3">-->
